...
export default function Level2Static({ onComplete, onReset }: Level2StaticProps) {
  ...
  const checkSolution = async () => {
    ...
    try {
      ...
      const result = staticStorage.validateLevel2Solution(formattedSolution);
